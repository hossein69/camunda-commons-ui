    ...
    return {
      ...
      link: function(scope, element) {
        ...
        function positionElements() {
          ...
          if (isDate()) {
            var $datepickerEl = $ctrlsEl[0].querySelector('.cam-widget-inline-field.field-control > .datepicker > div > div >table');
        ...
        scope.trapKeyboard = function(evt, reverse) {
          if(isDate() && evt.keyCode === 9) {
            ...
            if(!reverse && !evt.shiftKey) {
              ...
              $('.cam-widget-inline-field.field-control > .datepicker > div > div')[0].focus();
              evt.preventDefault();
