      ...
      link: function(scope, element, attrs, model) {
        ...
        $timeout(function() {
          ...
          element.bind('click', function() {
            // viewValue didn't change the $parsers are not invoked
            var isSameValue = model.$$lastCommittedViewValue === model.$viewValue;
          ...
          var parse = function() {
            model.$$parseAndValidate && model.$$parseAndValidate();
          };
